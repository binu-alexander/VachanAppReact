  ...
  try {
    ...
    if (payload.isDownloaded == true) {
      ...
      if (res.ok && res.status == 200) {
        ...
        let parallelBibleHeading =
          response.chapterContent.metadata &&
          response.chapterContent.metadata[0].section &&
          response.chapterContent.metadata[0].section.text;
        yield put(
          parallelBibleSuccess({
