...
export const VERSION_DOWNLOADED_CONTENT_FAILURE =
  "version_downloaded_content_failure";
export const VERSION_DOWNLOADED_CONTENT_SUCCESS =
  "version_downloaded_content_success";
