        ...
        <ScrollView >
          <View style={this.styles.textContainer}  >
            ...
            <Text style={this.styles.textStyle} textBreakStrategy={'simple'}>
              ...
              The content on VachanOnline and VachanGo is being made available under a collaborative arrangement among Friends of Agape, unfoldingWord, Wycliffe Associates, Crossway, Bridgeway Publications, Dusty Sandals, BibleProject, and Visual Unit, and Bridge Connectivity Solutions Pvt. Ltd. (BCS) (<Text textBreakStrategy={'simple'} style={this.styles.linkText} onPress={() => { Linking.openURL('https://beta.vachanonline.com') }}>https://beta.vachanonline.com</Text>) who is the localization and technology partner.{'\n'}
              <Text textBreakStrategy={'simple'} style={this.styles.TitleText}>{'\n'}Technology{'\n'}</Text>
