  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView
        ...
        <View>
          <Icon name='close' size={28} style={styles.headerCloseIcon} onPress={() => { this.props.navigation.pop() }} />
        </View>
        <View style={{ padding: 35, flex: 1 }}>
          ...
          <View style={styles.justifyItem}>
            ...
            <View>
              ...
              />
              <Icon name={this.state.passwordVisible1 ? 'eye' : 'eye-off'} size={24} style={styles.eyeIcon} onPress={() => this.setState({ passwordVisible1: !this.state.passwordVisible1 })} />
            </View>
            <View>
              <TextInput
                style={styles.inputStyle}
              ...
              />
              <Icon name={this.state.passwordVisible2 ? 'eye' : 'eye-off'} size={24} style={styles.eyeIcon} onPress={() => this.setState({ passwordVisible2: !this.state.passwordVisible2 })} />
            </View>
            <Button
