...
const Search = (props) => {
  ...
  const onSearchText = () => {
    ...
    async () => {
      if (downloaded) {
        ...
        var res = await vApi.get("search/" + JSON.parse(sourceId) + "?keyword=" + searchText
        );
        var data = [];
        console.log(" RES SERACHED ====>",res.result.length)
  ...
  return (
    <View style={style.container}>
      ...
      <Text style={style.textLength}>{searchFound}</Text>
