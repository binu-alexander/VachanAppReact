...
const BibleMainComponent = (props) => {
    ...
    const [{ currentVisibleChapter, styles, chapterContent, showBottomBar, showColorGrid, queryBookFromAPI, bottomHighlightText, unAvailableContent, reloadMessage, navigateToSelectionTab, isLoading }] = useContext(BibleContext);
    return (
        <CustomStatusBar>
            <View style={styles.container}>
                ...
                <View style={styles.singleView}>
                    ...
                    <View style={[styles.innerContainer, { width: visibleParallelView ? "50%" : width }]} >
